...
# 开发板IP地址
PI_IP = '192.168.43.206'

# 录音+语音识别
def asr_aipc():
    print('开始录音')
    terminal = 'ssh pi@{} "python3 TonyPi/OpenVINO/utils_asr.py"'.format(PI_IP)
    os.system(terminal)
    print('开始语音识别')
...
def tts(ai_response):
    ...
    os.system(terminal)
    print('开始语音合成')
    terminal = 'ssh pi@{} "python3 ~/TonyPi/OpenVINO/utils_tts.py"'.format(PI_IP)
    os.system(terminal)
    # print('播放完成')
