...
# 田径运动：巡线、跨栏、上下台阶
def athletics():
    os.system('python3 /home/pi/TonyPi/Extend/athletics_course/athletics_perform_only.py')

# 唱跳RAP
def rap():
    os.system('python3 /home/pi/TonyPi/Extend/sensor_course/sensor_development/little_apple.py')

# 踢足球
def kickball(color='red'):
    terminal = 'python3 /home/pi/TonyPi/Functions/KickBall_only_once.py {}'.format(color)
...
def transport(color_list_str='red green blue'):
    ...
    terminal = 'python3 /home/pi/TonyPi/Functions/Transport_only.py "{}"'.format(color_list)
    print('terminal', terminal)
    os.system(terminal)
